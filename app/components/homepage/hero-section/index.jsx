...
function HeroSection() {
  return (
    ...
    >
      <Image
        src="/hero.svg"
        alt="Illustration representing Hero section background"
        width={1572}
        height={795}
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="#contact-haseeb-idrees-software-engineer"
              aria-label="Contact me"
            >
              <button className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600 px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
            ...
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-amber-300">
                  "React", "NextJS", "Node", "Express", "NestJS", "Python",
                  "Django", "Ruby", "Ruby on Rails", "Redux", "MySQL",
                  "MongoDB", "Docker", "AWS"
                </span>
                <span className="text-gray-400">],</span>
              </div>
